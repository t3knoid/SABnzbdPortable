...
user in an INI file next to SABnzbdPortable.exe called SABnzbdPortable.ini.
...
copy AppNamePortable.ini from this directory to SABnzbdPortable.ini next to
SABnzbdPortable.exe. The options in the INI file are as follows:
